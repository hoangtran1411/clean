  ...
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        success: 'border-transparent bg-emerald-100 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300',
        warning: 'border-transparent bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300',
      },
    },
    defaultVariants: {
      variant: 'default',
