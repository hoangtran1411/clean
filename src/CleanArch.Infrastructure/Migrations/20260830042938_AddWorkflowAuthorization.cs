        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestPath = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderReference = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, collation: "NOCASE"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Level1ApprovedByUserId = table.Column<string>(type: "TEXT", nullable: true),
                    Level1ApprovedByUserName = table.Column<string>(type: "TEXT", nullable: true),
                    Level1ApprovedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Level2ApprovedByUserId = table.Column<string>(type: "TEXT", nullable: true),
                    Level2ApprovedByUserName = table.Column<string>(type: "TEXT", nullable: true),
                    Level2ApprovedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    FinalApprovedByUserId = table.Column<string>(type: "TEXT", nullable: true),
                    FinalApprovedByUserName = table.Column<string>(type: "TEXT", nullable: true),
                    FinalApprovedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedByUserId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ChangedByUserName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdempotentRequests_IdempotencyKey_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowRequests_RequestedByUserId",
